...
int main(int argc, char**argv){
	...
	fprintf(ficMakefile,"\t@echo \"CC         = \" $(CC)\n");
	fprintf(ficMakefile,"\t@echo \"CCFLAGS    = \" $(CCFLAGS)\n");
	fprintf(ficMakefile,"\t@echo \"LDFLAGS    = \" $(LDFLAGS)\n");
	fprintf(ficMakefile,"\t@echo \"SRCDIR     = \" $(SRCDIR)\n");
	fprintf(ficMakefile,"\t@echo \"INCDIR     = \" $(INCDIR)\n");
	fprintf(ficMakefile,"\t@echo \"OBJDIR     = \" $(OBJDIR)\n");
	fprintf(ficMakefile,"\t@echo \"BINDIR     = \" $(BINDIR)\n");
	fprintf(ficMakefile,"\t@echo \"INSTALLDIR = \" $(INSTALLDIR)\n");
